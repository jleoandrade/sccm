...
$ReportDirectory = "\\Njnwksmp0001v\d$\Reports Month MS - Oficial\July x June - Comparison Report"
...
$SourceFilePattern = "Desktop Deployment - Enterprise Production - Windows - * - * - *Desktop Clients* - Completo - ${TargetMonthName}-${TargetDayNumber} - *.xlsx"
