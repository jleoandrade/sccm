...
$LocalMsuPath  = "\\NJNWKSMS08V\Sources\Manual-installations\2026-07_Cumulative_Update_for_Windows_11_25H2\*.msu"
$RemoteFolder  = "C:\temp\kb\25h2"
...
foreach ($ComputerName in $ComputerList) {
    if (Test-Connection -ComputerName $ComputerName -Count 1 -Quiet) {
        $RemoteSharePath = "\\$ComputerName\c$\temp\kb\25h2"
