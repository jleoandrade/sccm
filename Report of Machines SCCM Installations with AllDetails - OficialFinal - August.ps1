...
$Global:OutputPath     = Join-Path $Global:TargetDirExcel "Collection_Report_SCCM_Installations_Aug_$Global:TimeStampExcel.xlsx"
...
$QueryHF = "SELECT ResourceID, HotFixID, InstalledBy, InstalledOn FROM SMS_G_System_QUICK_FIX_ENGINEERING WHERE HotFixID = 'KB5120240' OR HotFixID = 'KB5121003'"
